  ...
  return <div className={style.bar}>
    ...
    <link rel="stylesheet" href="https://fonts.googleapis.com/css2?family=Material+Symbols+Outlined:opsz,wght,FILL,GRAD@24,400,0,0" />
                ...
                <ul className={style.navUl1}>
                    <li className={style.navLi} ><NavLink  className={({ isActive }) => (isActive ? style.active : "")} to='/user/dashboard' onClick={() => handleLinkClick("Dashboard")}>
                      <span class="material-symbols-outlined">grid_view</span>
                     <span>Dashboard</span></NavLink></li>
                    <li className={style.navLi}><NavLink   className={({ isActive }) => (isActive ? style.active : "")} to='/user/properties' onClick={() => handleLinkClick("Properties")}><span class="material-symbols-outlined">apartment</span> <span>Properties</span></NavLink></li>
                    <li className={style.navLi}><NavLink   className={({ isActive }) => (isActive ? style.active : "")} to='/user/investment' onClick={() => handleLinkClick("Investment")}><span class="material-symbols-outlined">monitoring</span> <span>Investments</span></NavLink></li>
                    <li className={style.navLi}><NavLink   className={({ isActive }) => (isActive ? style.active : "")} to='/user/investments' onClick={() => handleLinkClick("Investments")}><span class="material-symbols-outlined">monitoring</span> <span>My Investments</span></NavLink></li>
                    ...
                    <li className={style.navLi}><NavLink  className={({ isActive }) => (isActive ? style.active : "")} to='/user/mine' onClick={() => handleLinkClick("Document")}><span class="material-symbols-outlined">sticky_note_2</span> <span>Documents</span></NavLink></li>

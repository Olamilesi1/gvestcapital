  ...
  return <div className={style.bar}>
    ...
    <link rel="stylesheet" href="https://fonts.googleapis.com/css2?family=Material+Symbols+Outlined:opsz,wght,FILL,GRAD@24,400,0,0" />
                ...
                <ul className={style.navUl1}>
                    ...
                    <li className={style.navLi}><NavLink  className={({ isActive }) => (isActive ? style.active : "")} to='/user/portfolio'><span class="material-symbols-outlined">rss_feed</span> <span>Portfolio</span></NavLink></li>

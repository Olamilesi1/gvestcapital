...
import Card from "../../components/reusables/Card"; // Assuming Card is another reusable component
import style from "../styles/UserPropt.module.css";
...
UserPropt.defaultProps = {
  buttonLabel: "View Detail",
  onButtonClick: () => {},
  dynamicCard: null,
};

export default UserPropt;

...
import style from "../styles/userpropertydetail.module.css";
              ...
              <div key={index} className={style.property}>
                ...
                <div className={style.propertyDiv}>
                  <div className={style.propertyTitle}>
                    <div className={style.packButan}>
                      <h2 className={style.package}>{investment.title1}</h2>
                      <div className={style.butan}>
                        <button className={style.now}>Invest Now </button>

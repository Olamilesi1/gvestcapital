            ...
            <div className={style.propertyList}>
              {properties.length > 0 ? (
                properties.map((property, index) => {
                  ...
                  return (
                    <div key={_id} className={style.propertyCard}>
                      ...
                      <div className={style.propertyDetails}>
                        ...
                        {openIndex === index && (
                          <div className={style.propertyMoreInfo}>
                            <p>Investment Option: {investmentOption}</p>
                            <p>ROI: {roi}</p>
                            <p>Duration: {duration}</p>
                          </div>
                        )}
                        <button
                          onClick={() => handleViewDetail(property.investmentCategory)}

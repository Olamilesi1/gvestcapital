      ...
      <div className={style.componentContent}>
        ...
        <div className={style.headerContent}>
          ...
          <div className={style.outline}>
           ...
           <p>Choose the investment strategy that works best for you-simple or compound interest. Start building your financial futre today.</p>

           <div className={style.simpleCompund}>
            <button className={style.simple} onClick={handleSimpleClick}>Simple Interest</button>
            <button className={style.compound} onClick={handleCompoundClick}>Compound Interest</button>
           </div>
          </div>
        </div>
      </div>

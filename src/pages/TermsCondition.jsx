    ...
    <div>
      ...
      <div className={style.home}>
        <div className={style.homeText}>
          <p className={style.homeText1}>Terms and Conditions</p>
        </div>
      </div>
      ...
      <div className={style.content}>
        ...
        <p>
          Welcome to GVest. By using our website and services, you agree to
        ...
        <p>
        - Company: Refers to GText, its subsidiaries, affiliates, and employees.
        </p>
        <p>
        -  User: Refers to any person accessing or using the website or services.
        </p>
        <p>
        ...
        <p>
          All transactions are processed securely. By making a payment, you
          agree to our terms for refunds and cancellations as detailed on the
        ...
        <p>
          ...
          images, is the property of GVest and is protected by copyright laws.
          Unauthorized use of this content is prohibited.
        </p>

        <p className={style.head}>7. Limitation of Liability</p>
        <p>
          GText is not liable for any indirect, incidental, or consequential
          damages resulting from the use of our services or platform.
        </p>
